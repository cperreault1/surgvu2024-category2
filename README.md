...
For category 2 of [Surgical Visual Understanding Challenge](https://surgvu24.grand-challenge.org/) (surgical step classification) the instructions to generate the Docker container are given below

### Category #2 – surgical step classification:  

TODO: fillthis part out
